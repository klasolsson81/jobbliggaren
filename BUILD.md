...
| Test-mocks | NSubstitute | 6.x | Mock-ramverk för Application-tester; 6.0.0 annoterar hela publika API:t nullable (se `Directory.Packages.props` för migrationsformen — `Arg.Is`-predikat kräver `!= null`, inte `is not null`) |
