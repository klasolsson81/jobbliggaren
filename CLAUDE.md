...
- **Backlog = GitHub Issues** (`area:`/`hotspot:`/`P0`–`P3`/lane `BE`·`FE`·
  ...
  (next bullet), as playbook §8.1 has said since 2026-06-25; playbook §9 carries who
  said what, when. Side-track PRs you own are shepherded to green before new scope.
