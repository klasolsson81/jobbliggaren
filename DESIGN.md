...
- `.jp-matchchip` — namngiven matchningsgrad. **Enda tillåtna matchningsformen**:
  aldrig mätare, procenttal eller ring (§8, ADR 0076 Decision 4, ADR 0053
  Amendment 2026-06-19). Föregångaren `.jp-match` (6px score bar) är borttagen.
