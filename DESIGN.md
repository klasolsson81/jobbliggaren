...
- **Mono caps (labels):** 11px (`--text-overline`) / letter-spacing 0.08–0.16em / UPPERCASE, färg `text-secondary` — kickers, kolumnhuvuden (`UPPDATERAD · MAJ 2026`); ALLA mono-caps-kickers är unifierade på denna enda rung (#549-konsolideringen, CTO D2)
