...
# what lights it. The pair was enabled 2026-08-18, so this threshold is now read -- though the
# probe still SKIPS until #197's credential exists, which is what keeps it quiet today. Set to
