...
**Senast uppdaterad:** 2026-05-17 (PRIO-1 CI-fix: ApiFactory seeder-determinism efter migrations — main-CI grön; handoff-diagnos falsifierad & korrigerad)
**HEAD:** `b3772a3` (fix(test) ApiFactory seeder efter MigrateAsync — main-`build`-CI grön run `25986194273`)
