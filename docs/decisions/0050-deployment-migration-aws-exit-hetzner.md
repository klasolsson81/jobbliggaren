...
|---|---|---|---|
| B-1 | Master-nyckel ALDRIG plaintext-på-disk på beta-VPS (systemd-credentials TPM-bunden el. sops+age→tmpfs; plaintext OK bara lokalt) | Blocker | ADR 0049 `Amendment 2026-08-09` — **#198 STÄNGD 2026-09-06** (Klas-beslut); mätrader `vps-deploy-stack.md` §5 rad 21–27 |
...
| M-3 | Körbar idempotent master-nyckel-re-wrap-rotation + kadens (minst årlig + händelse-driven vid box-kompromiss/offboarding) | Major | ADR 0049 `Amendment 2026-08-09` — **#198 STÄNGD 2026-09-06** (Klas-beslut); mätrader `vps-deploy-stack.md` §5 rad 21–27 |
...
| M-2 | ADR 0049-amendment: self-managed master-nyckels prod-skyddsmodell + accepterad minne-restrisk + namngiven skala-trigger för extern KV/HSM | Major | ADR 0049 `Amendment 2026-08-09` — **levererad**; #198 stängd 2026-09-06 |
