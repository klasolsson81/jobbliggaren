...
4a ships in six PRs (`senior-cto-advisor`, #1741's form round; the ruling is #1741 comment 5783718789, and its
follow-up added DX):
...
change-email →
**4a** #1741 in six PRs (Amendment 2026-09-22, #1741): A0 the tolerant reader → V1 the preamble cut → DX the DOCX
line model → A `Resume.FullName` optional, the CV half → B the account half, after 3b; RP beside them → **4b** #1742
