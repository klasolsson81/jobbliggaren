...
| 0055 | Platsbanken-popover ersätter disclosure-filtersektion (580px tvåkolumns-popover, live-commit utan Använd-knapp, ingen spara-sökning-knapp i /jobb; supersederar ADR 0042 Beslut A; ADR 0042 övriga beslut + ADR 0043 taxonomi-ACL/domänkontrakt oförändrade — endast presentation omprövad) | Accepted | 2026-05-19 | [0055-platsbanken-popover-replaces-disclosure-filter.md](./0055-platsbanken-popover-replaces-disclosure-filter.md) |
