...
| 0049 | TD-13 PII-fält-kryptering via KMS-envelope: per-användare-DEK för de 4 user-ägda kolumnerna + crypto-erasure för Art. 17-backup-täckning (komplementär till ADR 0024 — cross-ref EJ amendment); raw_payload exkluderas medvetet (ADR 0032/0039-load-bearing); hybrid lazy-write + bounded backfill; jsonb→text via expand/contract — FAS 3.5 STOPP D-utkast | Proposed | 2026-05-18 | [0049-td13-pii-field-encryption-kms-envelope.md](./0049-td13-pii-field-encryption-kms-envelope.md) |
