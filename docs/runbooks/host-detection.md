...
# backup-restore.md (one carries `systemd-tmpfiles --create`, the other does not). A third home
...
# AFTER #198's cutover, replace the two lines above with the real key read:
