...
- **Backup and restore** — [`backup-restore.md`](backup-restore.md) (#197): the nightly job,
  ...
  row is open on nothing but Klas's escrow confirmation. The 2026-08-09 identity is REVOKED.**
