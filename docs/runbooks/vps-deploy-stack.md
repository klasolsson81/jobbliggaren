...
**B-1 is therefore still open, and its predicate is not this list.** `:689` states it: B-1 is
discharged when rows **21–25** carry measurements. After this pass 21, 22 and 25 do; 23 carries
