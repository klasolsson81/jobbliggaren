...
36 ARE LIVE.** *(This banner read "rows 33–35 … row 36 … the only live row" until 2026-08-16, and
both halves were falsified in the same edit that re-instrumented row 35 — see that row and the
paragraph below. The paragraph was narrowed and the banner nine lines above it was not, which is the
defect class this block keeps producing: the fix landed on one of two homes.)* Row 35's property was
never SES-specific and it now carries a runnable Scaleway-console instrument; row 36 was never about
SES at all. AWS refused production access permanently
