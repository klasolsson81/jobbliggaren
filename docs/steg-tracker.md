...
> **Version:** 1.11
> **Senast uppdaterad:** 2026-05-10 (STEG 13a + 13b APPLIED)
...
**STEG-fokus:** STEG 13a + 13b APPLIED 2026-05-10. Hela infra-stacken uppe i eu-north-1 (VPC + RDS + Redis + ECR + ALB + ECS + IAM + CW LogGroups + secrets). Api smoke-test PASS via ALB-DNS. Worker i restart-loop pga PLACEHOLDER DB-creds (förväntat tills STEG 14 DDL+roller). Spend ~$79/mån löper ($2.60/dag). ADR 0026 deadline 2026-06-08 (29 dagar). Nästa: STEG 13c (Route53 + ACM + HTTPS-flip — TD-30/ADR 0026-trigger 1) ELLER STEG 14 (GitHub Actions + DDL-init + IAM cleanup).
