...
namespace JobbPilot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260612120000_B2RecentJobSearchKlass2Columns")]
    partial class B2RecentJobSearchKlass2Columns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobbPilot.Domain.RecentJobSearches.RecentJobSearch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("JobbPilot.Domain.SavedJobAds.SavedJobAd", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("JobbPilot.Domain.SavedSearches.SavedSearch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("JobbPilot.Infrastructure.Persistence.UserDataKey", b =>
                {
                    b.Property<Guid>("JobSeekerId")
                        .HasColumnType("uuid")
                        .HasColumnName("job_seeker_id");
            ...
            modelBuilder.Entity("JobbPilot.Infrastructure.Taxonomy.TaxonomyConcept", b =>
                {
            ...
            modelBuilder.Entity("JobbPilot.Infrastructure.Taxonomy.TaxonomySnapshotMeta", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("JobbPilot.Domain.Applications.Application", b =>
                {
                    b.OwnsOne("JobbPilot.Domain.Applications.ManualPosting", "ManualPosting", b1 =>
                        {
