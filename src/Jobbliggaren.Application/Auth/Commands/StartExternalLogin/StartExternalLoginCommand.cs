...
/// <summary>
/// #1744 — start a login at a provider (ADR 0142 D8). <see cref="Next"/> is the post-login path; the flow
/// carries it to the callback as an echo.
/// </summary>
public sealed record StartExternalLoginCommand(string? Provider, string? Next) : ICommand<Result<ExternalLoginStart>>;

/// <summary>Where to send the browser, and the state.</summary>
