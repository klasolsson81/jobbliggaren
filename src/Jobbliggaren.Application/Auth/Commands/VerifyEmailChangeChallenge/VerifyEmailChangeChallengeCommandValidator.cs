...
public sealed class VerifyEmailChangeChallengeCommandValidator : AbstractValidator<VerifyEmailChangeChallengeCommand>
{
    public VerifyEmailChangeChallengeCommandValidator()
    {
