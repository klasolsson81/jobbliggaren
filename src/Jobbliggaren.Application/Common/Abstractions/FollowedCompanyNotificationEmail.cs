...
/// phrasing; <see cref="TotalCount"/> is the number of ads that COULD have been shown
/// (≥ <see cref="Items"/>.Count when the display is capped) so the template can render "och N till".
/// <b>#864 — read this before re-wiring the field:</b> it counts PRESENTABLE ads (the ad is
