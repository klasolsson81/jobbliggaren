...
/// <summary>
/// Thrown by <c>ReauthenticationBehavior</c> when an <c>IReauthenticatingRequest</c>'s grant
/// does not validate, every cause indistinguishable. Mapped centrally in the Api (<c>Program.cs</c>) to a byte-identical
