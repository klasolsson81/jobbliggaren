...
/// </summary>
/// <remarks>
/// <b>The tension this resolves.</b> Art. 5(2) says record what you did. Art. 5(1)(c) says do not
/// keep her email. A plaintext identifier in <c>audit_log</c> would mean the erasure request itself
/// becomes the last place her address survives.
/// <para>
...
/// it is a fig leaf. (<c>md5</c> is rejected outright.) A keyed HMAC with a server-held pepper is
/// not reversible without the pepper, which is what makes the output pseudonymous data under
/// Art. 4(5) rather than merely obscured personal data.
/// </para>
/// <para>
