...
/// <c>MAX_CONCEPT_IDS</c> = 400 org.nrs on an every-value-or-none doctrine, against a criterion that
/// matched 3 981 companies in the measured case; and its <c>municipality</c> axis is the AD's
