...
/// <summary>
/// Bevakning F2 (#801, RF-6=6B) — the count of new ads from followed employers NEW since the user
/// last acknowledged the rail on /foretag/bevakade/nya (<c>FollowedCompanyAdHit.CreatedAt &gt;
