...
/// <summary>
/// The callback URL for each provider, built from the site's one public base URL (ADR 0142 D8: no
...
{
    /// <summary>The provider consoles register this path on every host.</summary>
