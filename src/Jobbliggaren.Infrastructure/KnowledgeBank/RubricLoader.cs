...
/// <summary>
/// Loads the committed, versioned CV-quality rubric (<c>rubric.v2.1.0.json</c>)
...
internal static class RubricLoader
{
    ...
    private const string ResourceName =
        "Jobbliggaren.Infrastructure.KnowledgeBank.rubric.v2.1.0.json";

    /// <summary>Loads the committed rubric asset (currently <c>rubric.v2.1.0.json</c>) from
