...
namespace Jobbliggaren.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260906182044_AddCriterionMaterialisationFingerprint")]
    partial class AddCriterionMaterialisationFingerprint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.Applications.Application", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastFollowUpAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_follow_up_at");
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.JobSeekers.JobSeeker", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastSeenFollowedAdsAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_seen_followed_ads_at");
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.Resumes.Files.ResumeFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<byte[]>("SealedContent")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("content");

                    b.HasKey("Id")
                        .HasName("pk_resume_files");

                    b.HasIndex("JobSeekerId")
                        .HasDatabaseName("ix_resume_files_job_seeker_id");

                    b.HasIndex("ParsedResumeId")
                        .HasDatabaseName("ix_resume_files_parsed_resume_id");

                    b.ToTable("resume_files", (string)null);
                });
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.Resumes.Resume", b =>
                {
                    ...
                    b.Property<string>("ReviewedRubricVersion")
                        .HasMaxLength(14)
                    ...
                    b.Property<Guid?>("SourceParsedResumeId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.SavedSearches.SavedSearch", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ResultsSeenAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("results_seen_at");
            ...
            modelBuilder.Entity("Jobbliggaren.Infrastructure.CompanyRegister.ScbCompanyRegisterEntry", b =>
                {
                    ...
                    b.HasIndex("Name", "OrganizationNumber")
            ...
            modelBuilder.Entity("Jobbliggaren.Domain.Resumes.Resume", b =>
                {
                    b.OwnsOne("Jobbliggaren.Domain.Resumes.CvTemplateOptions", "TemplateOptions", b1 =>
                        {
                            ...
                            b1.Property<string>("Density")
                                .IsRequired()
                                .HasMaxLength(30)
                                .HasColumnType("character varying(30)")
                                .HasColumnName("template_density");

                            b1.Property<string>("FontPair")
                                .IsRequired()
                                .HasMaxLength(30)
                                .HasColumnType("character varying(30)")
                                .HasColumnName("template_font");

                            b1.Property<bool>("PhotoEnabled")
                                .HasColumnType("boolean")
                                .HasColumnName("template_photo_enabled");

                            b1.Property<string>("PhotoShape")
                                .IsRequired()
                                .HasMaxLength(30)
                                .HasColumnType("character varying(30)")
