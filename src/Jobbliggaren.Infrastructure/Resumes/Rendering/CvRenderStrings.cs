...
{
    /// <summary>The localised section heading labels for one output language.</summary>
    ...
    private static readonly Labels Swedish =
        new("Kontakt", "Profil", "Arbetslivserfarenhet", "Utbildning", "Kompetenser", "Språk");

    private static readonly Labels English =
        new("Contact", "Profile", "Experience", "Education", "Skills", "Languages");
