...
/// <c>JobbPilot.Application</c> — Application-handlers ska aldrig kunna querera
...
/// <list type="bullet">
/// <item><c>JobbPilot.Infrastructure.Persistence.UserDataKey</c> — keyless
...
/// <item>Ingen typ i <c>JobbPilot.Application</c>-assemblyn refererar
/// <c>UserDataKey</c>.</item>
/// </list>
public class FieldEncryptionKeyStoreLayerTests
{
    private const string UserDataKeyFqn =
        "JobbPilot.Infrastructure.Persistence.UserDataKey";
    ...
    public void IAppDbContext_DoesNotExpose_UserDataKey()
    {
        ...
        var appDbContextPort = typeof(JobbPilot.Application.Common.Abstractions.IAppDbContext);
    ...
    {
        // CTO FRÅGA 2 (b): ingen typ i JobbPilot.Application får ha en
        ...
        result.IsSuccessful.ShouldBeTrue(
            "JobbPilot.Application får inte referera UserDataKey (FRÅGA 2, " +
    ...
    public void Domain_DoesNotReference_FieldEncryption_Or_UserDataKey()
    {
        ...
        var result = Types.InAssembly(typeof(JobbPilot.Domain.Common.Entity<>).Assembly)
            .ShouldNot()
            .HaveDependencyOnAny(
                "JobbPilot.Application.Common.Security.IFieldEncryptor",
                "JobbPilot.Application.Common.Security.IDataKeyProvider",
                "JobbPilot.Application.Common.Security.GeneratedDataKey",
                UserDataKeyFqn,
