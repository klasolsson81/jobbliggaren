...
/// <para>
/// No path in <c>src/</c> writes that column since #1741 PR B (ADR 0142 D7); the pin is
/// <c>JobSeekerTests.DisplayName_HasNoWritePathOnTheAggregate</c>. A test that needs a named account therefore asserts about a row a RETIRED actor wrote:
