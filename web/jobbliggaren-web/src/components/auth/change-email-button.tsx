...
// The way out of a step, to start over with another address: a submit that LOOKS like a text
// link, not a link. A GET cannot clear a cookie, so a link would leave what the user just walked
// away from on the device: the typed address on the code step, the live grant on the consent
...
//
// The classes put the auth text-link form on the `link` variant:
