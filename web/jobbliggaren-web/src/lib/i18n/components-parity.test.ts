...
describe("components i18n-paritet (sv ↔ en)", () => {
  ...
  it("yrkesblockets nycklar finns i båda katalogerna (#1682, ADR 0137)", () => {
    const required = [
      ...
      "criterionPicker.occupationShareUnderOne",
      "criterionPicker.occupationBelowThreshold",
      "criterionPicker.occupationWithoutDivision",
      "criterionPicker.noMatchOccupation",
      "criterionPicker.filterMatchesOccupation",
