// F-Pre Punkt 6 — JobbPilot brand-mark (CTO 2026-05-24 Beslut 4 + Klas-val C4 2026-05-25).
...
export interface BrandLogoProps {
  /**
   * `full` (default) renderar mark + wordmark "JobbPilot".
  ...
  return (
    <>
      <BrandMarkSvg
        ...
        ariaLabel={variant === "mark" ? "JobbPilot" : undefined}
      />
      {variant === "full" ? (
